...
void Package::storeTypeAndId(int id) {
  entityStorage.tripID = id;
  entityStorage.entityType = "PACKAGE";
}

void Package::sendPackageData() {
  DataDashboard::getInstance()->addEntity(entityStorage);
}

void Package::storeMovingStrat() { entityStorage.strategy = "N/A"; }
